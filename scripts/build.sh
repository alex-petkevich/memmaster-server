...
sleep 3
cp ./target/memmaster-server-1.0.0-SNAPSHOT.jar /mnt/vol1/www/memmaster-server/memmaster-server.jar
chown memmaster:memmaster /mnt/vol1/www/joplin/memmaster-server.jar
